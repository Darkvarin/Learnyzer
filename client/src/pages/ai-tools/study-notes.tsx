        ...
        if (printWindow) {
          const htmlContent = `
            ...
            <body>
              <div class="header">
                <h1>${topic}</h1>
                <p><strong>Subject:</strong> ${subject} | <strong>Style:</strong> ${style} | <strong>Level:</strong> ${level}</p>
                <p><strong>Generated by Learnyzer AI</strong> | ${new Date().toLocaleDateString()}</p>
              </div>
